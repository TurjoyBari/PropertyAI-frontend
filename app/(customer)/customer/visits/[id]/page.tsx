    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          ...
          <p className="mt-2 text-sm font-medium">{VISIT_STATUS_LABELS[visit.status]}</p>
          {visit.locationNote ? (
          ...
          {canModify ? (
            <>
              ...
              <button
                ...
                className="rounded-xl border border-[var(--border)] px-4 py-2.5 text-sm font-medium text-[var(--danger)] disabled:opacity-60"
              >
                Cancel Visit
              </button>
            </>
